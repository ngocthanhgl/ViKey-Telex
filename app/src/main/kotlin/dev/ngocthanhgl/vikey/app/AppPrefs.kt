...
import dev.ngocthanhgl.vikey.app.settings.theme.ColorPreferenceSerializer
import dev.ngocthanhgl.vikey.app.settings.theme.DisplayKbdAfterDialogs
import dev.ngocthanhgl.vikey.app.settings.theme.SnyggLevel
...
import dev.ngocthanhgl.vikey.ime.smartbar.quickaction.QuickAction
import dev.ngocthanhgl.vikey.ime.smartbar.quickaction.QuickActionArrangement
import dev.ngocthanhgl.vikey.ime.smartbar.quickaction.QuickActionJsonConfig
import dev.ngocthanhgl.vikey.ime.text.gestures.SwipeAction
import dev.ngocthanhgl.vikey.ime.text.key.KeyCode
import dev.ngocthanhgl.vikey.ime.text.key.KeyHintConfiguration
...
import dev.ngocthanhgl.vikey.ime.theme.extCoreTheme
import dev.ngocthanhgl.vikey.ime.window.ImeWindowConfig
import dev.ngocthanhgl.vikey.lib.ext.ExtensionComponentName
import dev.ngocthanhgl.vikey.lib.util.VersionName
        ...
        return when (entry.key) {
            ...
            "media__emoji_recently_used" -> {
                ...
                val recent = emojiValues.map {
                    dev.ngocthanhgl.vikey.ime.media.emoji.Emoji(it, "", emptyList())
                }
            ...
            // Suggestion is now Telex-safe (tap-to-commit, no auto-commit).
            // Keep existing pref value; defaults to true for new installs.
            "suggestion__enabled" -> {
                entry.keepAsIs()
            }
