...
import dev.ngocthanhgl.vikey.ime.keyboard.LayoutTypeId
import dev.ngocthanhgl.vikey.ime.keyboard.extCoreComposer
import dev.ngocthanhgl.vikey.ime.keyboard.extCoreCurrencySet
...
data class Subtype(
    ...
    companion object {
        ...
        val DEFAULT = Subtype(
            ...
            popupMapping = extCorePopupMapping("vi-VN"),
